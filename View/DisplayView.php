...
div
		< id="compose-btn"><a  class="btn" href="#popup_composition" onClick="composerReleves()" >Créer le relevé multiple</a></div>
...
END;
												...
												<div class="modal-header">
															   <button class="close" data-dismiss="modal">×</button>
																									  ...
																									  <div class="modal-body">
																													 <p>Name de la composition : <input type="text" id="mrname" name="mrname" /> </p>
	...
	<div class="modal-footer">
							   <a href="#" onClick="$('#popup_composition').modal('hide')" class="btn"><?php echo _('Cancel');
		?></a>
